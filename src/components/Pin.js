...
function Pin(props) {
    ...
    const [pinFavourite, setPinFavourite] = useState();
    const [pinNotification, setPinNotification] = useState(false);
    const handleFavourite = ()=>{
        //setPinFavourite(props.pinDetails);
    ...
    return (
        ...
        <div className={`card card_${props.pinDetails.pin_size}`}>
            ...
            <div className="pin_modal">
                ...
                <div className="modal_foot">
                    <div className="destination">
                        ...
                        <span><Linkify properties={{target: '_blank'}}> {props.pinDetails.destination}</Linkify></span>
                    </div>
                    ...
                    <div className="pint_mock_icon_container">
                        <img onClick={handleFavourite} src="./images/ellipse.png" alt="edit" className="pint_mock_icon" />
                    </div>
                </div>
            </div>
            ...
            <Favourite pinFavourite={pinFavourite} />
            <Notifications pinNotification={pinNotification}/>
        </div>
        // </div>
    )
}
